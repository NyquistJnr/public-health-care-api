...
SECRET_KEY = 'django-insecure-7ttqf@9sr75gu=)qjuhei&hn^nz*)n%&44q4#v^96-=c@-)id!'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'core.renderers.UniformJSONRenderer',
    ),
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=20), # timedelta(minutes=60),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Public Health Care System API',
...
TENANT_DEBUG_TOKEN = os.environ.get('TENANT_DEBUG_TOKEN')
DEFAULT_TENANT_SCHEMA = os.environ.get('DEFAULT_TENANT_SCHEMA')

TELEMEDICINE_API_URL = os.environ.get('TELEMEDICINE_API_URL', 'http://localhost:8000/v1')
TELEMEDICINE_API_KEY = os.environ.get('TELEMEDICINE_API_KEY')
TELEMEDICINE_WEBHOOK_SECRET = os.environ.get('TELEMEDICINE_WEBHOOK_SECRET')
